...
class Qwen3TTSTokenizer:
    """
    A wrapper for the Qwen3 TTS Tokenizer (12Hz) with HuggingFace-style loading.
    ...
    def decode(
        ...
        # Normalize `encoded` into the same shape as the official demo uses.
        ...
        with torch.inference_mode():
            if model_type == "qwen3_tts_tokenizer_12hz":
                ...
                raise ValueError(f"unsupported audio tokenizer model_type {model_type!r}")
